...
const ViewAllReviews = () => {
  ...
  return (
    <div className="min-h-screen p-4 bg-slate-100 overflow-y-auto">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl sm:text-6xl font-bold mb-4 text-center text-gray-800">
          All Reviews
        </h1>
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between items-center my-5 space-y-3 sm:space-y-0 gap-4">
        ...
        {filteredReviews.length === 0 ? (
          ...
          <div className="grid gap-4">
            {filteredReviews.map((review) => (
              <li
                key={review._id}
                className="border p-6 rounded-lg shadow-md bg-white hover:shadow-lg transition-shadow duration-200 list-none"
              >
                ...
                <div className="mt-4 flex flex-col sm:flex-row gap-2">
                  <button
                    className="bg-green-500 hover:bg-green-700 text-white px-4 py-2 rounded-md transition-colors duration-200 flex-1 sm:flex-none"
                    onClick={() => {
                  ...
                  <button
                    className="bg-red-500 hover:bg-red-700 text-white px-4 py-2 rounded-md transition-colors duration-200 flex-1 sm:flex-none"
                    onClick={() => {
